...
grocery_spendings_for_month = float(input('Ask customer for monthly grocery spendings'))
income_for_month = float(input('Ask how much customer makes per month'))


percentage_of_monthly_income_spent_on_groceries = (grocery_spendings_for_month / income_for_month) * 100
